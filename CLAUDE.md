...
| Skill                  | Quando usar                                         | Não usar                              |
|------------------------|-----------------------------------------------------|---------------------------------------|
| `embedded-cpp`         | C++, memória, ISR, flash strings, relay, sensor     | tooling, JSON, docs                   |
| `platformio-build`     | build, flash, monitor, platformio.ini               | só docs                               |
| `cpp-coding-standards` | escrever/revisar/refatorar C++                      | não-C++, C legado, conflito com HW    |
